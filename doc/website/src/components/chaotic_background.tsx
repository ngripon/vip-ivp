...
import "./chaotic_background.css";

export function ChaoticBackground({ className = "" }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Defer animation setup until after the page has loaded
  ...
  return (
    <div className={`absolute inset-0 ${className}`}>
      <canvas ref={canvasRef} className="w-full h-full -z-10 opacity-30" />
    </div>
  );
}
